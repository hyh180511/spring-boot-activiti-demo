...
import com.dapeng.demo.common.handler.impl.ProcessHandler;
...
public class ProcessController {
    ...
    public ResponseData<Deployment> deployRepeat(String name) {
        ...
        //Deployment deploy = actProcessHandler.deploy("processes/bpmn/leaveNew.bpmn", "processes/bpmn/leaveNew.png",name, "leave category");
        Deployment deploy = processHandler.deploy("processes/bpmn/image.bpmn", name, "leave category");
